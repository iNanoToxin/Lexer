...
class BigInt {
    ...
    public:
        ...
        inline friend std::istream& operator>>(std::istream&, BigInt&);
        inline friend std::ostream& operator<<(std::ostream&, const BigInt&);
        ...
        inline friend BigInt big_random(size_t);
};
